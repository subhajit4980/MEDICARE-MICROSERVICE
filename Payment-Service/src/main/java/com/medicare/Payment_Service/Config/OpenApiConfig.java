package com.medicare.Payment_Service.Config;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                title = "User service", // Title of the API
        ...
        servers = {
                @Server(
                        ...
                        url = "http://localhost:8070/" // Base URL of the server
                ),
                @Server(
                        description = "Docker ENV", // Description of the server
                        url = "http://payment-service:8070/" // Base URL of the server
                )
